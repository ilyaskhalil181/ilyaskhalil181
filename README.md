...
Software Engineer focused on building responsive, scalable web and mobile applications with modern architectures.

#### Tech Stack
* **Frontend:** React.js, Tailwind CSS, JavaScript (ES6+), HTML5, CSS3, REST APIs
* **Backend & Cloud:** Node.js, Express, Firebase (Firestore & Auth), Python, C++
